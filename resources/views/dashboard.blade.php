    ...
    <x-slot:header>
        ...
        <div
            ...
            <a href="{{ route('teams.show', Auth::user()->currentTeam->id) }}">
                <x-button.secondary-leading-icon icon="icon.outline.cog" color="blue">{{ __('Team Settings') }}
                </x-button.secondary-leading-icon>
            </a>

            <x-button.primary-leading-icon onclick="window.livewire.emit('openCreateGigSlideOver')"
                                           icon="icon.solid.plus-sm"
                                           color="blue">Add Gig</x-button.primary>
        </div>
    </x-slot:header>
            ...
            <section aria-labelledby="band-members-title">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6">
                        <h2 id="band-members-title" class="text-lg leading-6 font-medium text-gray-900">
                            {{ __('Band Members') }}</h2>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">tbd</p>
                    </div>
